package com.example.test.Step21.Patient.CPatientHome.FBottomNavigation
...
class NavigationAppointmentBookedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_navigation_appointment_booked)
        ...
        bottomNavigationView.selectedItemId = R.id.navigation_Appointments
        bottomNavigationView.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                R.id.navigation_Home -> {
                    // Navigate to Chats fragment/activity
                    startActivity(Intent(this@NavigationAppointmentBookedActivity, PatientHomeActivity::class.java))
                    finish()
                    true
                }
                R.id.navigation_Appointments -> {
                    // Navigate to Calls fragment/activity
                    startActivity(Intent(this@NavigationAppointmentBookedActivity, NavigationAppointmentBookedActivity::class.java))
                    finish()
                    true
                }
                R.id.navigation_History -> {
                    // Navigate to Calls fragment/activity
                    startActivity(Intent(this@NavigationAppointmentBookedActivity, NavigtionHistory2Activity::class.java))
                    finish()
                    true
                }
                else -> false
    ...
    private fun redirectToLogin() {
        ...
        with(sha.edit()) {
            ...
            editor.clear()
            editor.apply()
            startActivity(Intent(this@NavigationAppointmentBookedActivity, LoginActivity::class.java))
            Toast.makeText(
                this@NavigationAppointmentBookedActivity,
