...
import com.example.test.Step21.Patient.CPatientHome.CHistory.CustomHistoryAdapter
import com.example.test.Step21.Patient.CPatientHome.PatientHomeActivity
import com.google.android.material.bottomnavigation.BottomNavigationView
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore

class NavigtionHistory2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_navigtion_history2)
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                R.id.navigation_Home -> {
                    ...
                    startActivity(Intent(this@NavigtionHistory2Activity, PatientHomeActivity::class.java))
                    finish()
                    true
                }
                R.id.navigation_Appointments -> {
                    // Navigate to Calls fragment/activity
                    startActivity(Intent(this@NavigtionHistory2Activity, NavigationAppointmentBookedActivity::class.java))
                    finish()
                    true
                }
                R.id.navigation_History -> {
                    // Navigate to Calls fragment/activity
                    startActivity(Intent(this@NavigtionHistory2Activity, NavigtionHistory2Activity::class.java))
                    finish()
                    true
                }
                else -> false
    ...
    private fun redirectToLogin() {
        ...
        with(sha.edit()) {
            ...
            editor.clear()
            editor.apply()
            startActivity(Intent(this@NavigtionHistory2Activity, LoginActivity::class.java))
            Toast.makeText(
                this@NavigtionHistory2Activity,
